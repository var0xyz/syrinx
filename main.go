...
func main() {
	...
	api.HandleFunc("/federation/servers/{id}/approve", h.ApproveFederationServer).Methods("POST")
	api.HandleFunc("/federation/servers/{id}/approve", h.noop).Methods("OPTIONS")
	api.HandleFunc("/federation/servers/{id}/reject", h.RejectFederationServer).Methods("POST")
	api.HandleFunc("/federation/servers/{id}/reject", h.noop).Methods("OPTIONS")
