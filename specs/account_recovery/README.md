...
| **Import** | Full encrypted backup (`.sxb.gz.gpg`) written to a new origin |
...
| [01](01_key_export.md) | Key export format + profile Export key | 00 |
...
| Key | **Active** private key only; Export key under Revoke |
